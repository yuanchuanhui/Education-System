...
;layui.define(function(e){
    layui.use(["admin","carousel"],function(){
        ...
        e(".layadmin-carousel").each(function(){
            ...
            trigger:i.ios||i.android?"click":"hover",anim:a.data("anim")
    ...
    layui.use(["admin","carousel","echarts"],function(){
        var e=layui.$,
            ...
            o=function(e){l[e]=i.init(r[e],layui.echartsTheme),l[e].setOption(n[e]),t.resize(function(){l[e].resize()})};

        if(r[0]){
            o(0);
            var d=0;
            a.on("change(LAY-index-dataview)",function(e){o(d=e.index)}),
            ...
            e.render({
                ...
                cols:[
                    [
                        ...
                        {field:"frequency",title:"搜索次数",minWidth:120,sort:!0},{field:"userNums",title:"用户数",sort:!0}]],skin:"line"}),
                e.render(
                    {
                        ...
                        cols:[[
                            ...
                            {field:"username",title:"发帖者"},{field:"channel",title:"类别"},{field:"crt",title:"点击率",sort:!0}
                            ]],
                        skin:"line"}
                        )
        }),

        ...
        layui.use(["carousel","echarts"],function(){
                                ...
                                var h=[],
                                    f=[
                                        {   title:{text:"雨量流量关系图",x:"center"},
                                            tooltip:{
                                                trigger:"axis",
                                                formatter:function(e){return e[0].name+"<br/>"+e[0].seriesName+" : "+e[0].value+" (m^3/s)<br/>"+e[1].seriesName+" : "+-e[1].value+" (mm)"}
                                            },
                                            ...
                                            yAxis:[
                                                {name:"流量(m^3/s)",type:"value",max:500},
                                                {name:"降雨量(mm)",type:"value",axisLabel:{formatter:function(e){return-e}}}
                                            ],
                                            series:[
                                                {   name:"流量",
                                                    type:"line",
                                    ...
                                    w=[
                                        {
                                            ...
                                            xAxis:[{type:"category",name:"x",splitLine:{show:!1},data:["一","二","三","四","五","六","七","八","九"]}],
                                            yAxis:[{type:"log",name:"y"}],
                                            calculable:!0,
                                            series:[
                                                {name:"3的指数",type:"line",data:[1,3,9,27,81,247,741,2223,6669]},
            ...
            layui.use(["carousel","echarts"],function(){
                                    var e=layui.$,
                                        a=(layui.carousel,layui.echarts),
                                        t=[],
                                        i=[{title:{text:"某地区蒸发量和降水量",subtext:"纯属虚构"},
                                            tooltip:{trigger:"axis"},
                                            legend:{data:["蒸发量","降水量"]},
                                            calculable:!0,
